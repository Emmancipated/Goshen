...
// import { ServiceDetail } from "@/app/our-work/our-work-data";
...
//                   <div className="mt-8 rounded-2xl border border-[#E4D8CB] bg-white/70 p-5">
//                     <p className="text-sm leading-6 text-[#5E5752]">
//                       Every service is delivered with dignity, confidentiality
//                       and respect for every woman and child.
//                     </p>
//                   </div>
//                 </div>
//               </div>
