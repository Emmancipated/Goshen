...
export function HeartIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M12 20.5C6 16 3.5 12.7 3.5 9.4 3.5 7 5.4 5 7.8 5c1.7 0 3.2.9 4.2 2.3C13 5.9 14.5 5 16.2 5c2.4 0 4.3 2 4.3 4.4 0 3.3-2.5 6.6-8.5 11.1z" />
    </svg>
  );
}
...
export function UsersIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M15.5 14.5c2.6.2 4.6 1.8 5.3 4.5" />
    </svg>
  );
}
...
export function ChildIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M6 21c.8-3.5 3-6 6-6s5.2 2.5 6 6" />
      <path d="M12 11v10" />
    </svg>
  );
}
...
export function WhatsAppIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 2.5A9.5 9.5 0 0 0 3 14.8L2 22l7.3-1.9A9.5 9.5 0 1 0 12 2.5zm0 17.4a7.9 7.9 0 0 1-4-.9l-.3-.2-4.3 1.1 1.2-4.2-.2-.3a7.9 7.9 0 1 1 7.6 4.5zm4.4-5.9c-.2-.1-1.5-.7-1.7-.8-.2-.1-.4-.1-.6.1-.2.2-.7.8-.8 1-.1.2-.3.2-.5.1a6.5 6.5 0 0 1-2-1.2 7.4 7.4 0 0 1-1.4-1.7c-.1-.2 0-.4.1-.5l.4-.5c.1-.2.2-.3.3-.5.1-.2 0-.4 0-.5l-.8-1.9c-.2-.5-.4-.4-.6-.4h-.5c-.2 0-.5.1-.7.3-.2.3-.9.9-.9 2.2s.9 2.5 1 2.7c.1.2 1.8 2.8 4.4 3.9.6.3 1.1.4 1.5.6.6.2 1.2.2 1.6.1.5-.1 1.5-.6 1.7-1.2.2-.6.2-1.1.2-1.2-.1-.2-.3-.2-.5-.3z" />
    </svg>
  );
}
...
export function FacebookIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M14 8.5V6.8c0-.8.6-1.3 1.3-1.3h2.2V2.6h-2.9C11.6 2.6 10 4.9 10 7.4v1.1H7.6v3H10V21.4h4V11.5h2.7l.4-3H14z" />
    </svg>
  );
}
...
export function XSocialIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M17.8 3h3l-6.6 7.5L22 21h-6.1l-4.8-6.3L5.7 21h-3l7-8L2 3h6.3l4.3 5.7L17.8 3zm-1.1 16.2h1.7L7.3 4.7H5.5l11.2 14.5z" />
    </svg>
  );
}
...
export function NairaIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M7 3v18" />
      <path d="M17 3v18" />
      <path d="M4 8.5h16" />
      <path d="M4 15.5h16" />
      <path d="M4 8.5 20 15.5M20 8.5 4 15.5" />
    </svg>
  );
}
...
export function HealthIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M12 21S3 15.5 3 9.6 6.4 4 9.5 4c1.1 0 2 .4 2.5 1.2C12.5 4.4 13.4 4 14.5 4 17.6 4 21 6.3 21 9.6c0 5.9-9 11.4-9 11.4z" />
      <path d="M8 12h3l1-2.5 2 5 1-2.5h3" />
    </svg>
  );
}
...
export function BriefcaseIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M8.5 7.5V5a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v2.5" />
      <path d="M3 13h18" />
      <path d="M12 11v2" />
    </svg>
  );
