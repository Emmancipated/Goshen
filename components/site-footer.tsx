...
//             <a href="/privacy-policy" className="hover:text-cream-50">
//               Privacy
//             </a>
//             <a href="/terms-and-conditions" className="hover:text-cream-50">
//               Policies
//             </a>
//             <a href="/accessibility" className="hover:text-cream-50">
//               Accessibility
//             </a>
//           </div>
//         </div>
...
export function SiteFooter() {
  ...
  return (
    <footer className="bg-night-950 text-white/70">
      ...
      {/* Bottom Sub-Footer: Styled to match image layout precisely */}
      <div className="border-t border-night-900/80">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-4 px-4 py-8 text-center text-xs leading-relaxed text-white/60 sm:px-6">
          {/* Copyright line */}
          ...
          {/* Links with vertical pipe dividers */}
