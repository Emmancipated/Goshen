    ...
    <footer className="bg-night-950 text-white/70">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.1fr]">
        ...
        <nav aria-label="Quick links">
          <h3 className="text-sm font-bold uppercase tracking-wider text-cream-50">Quick Links</h3>
        ...
        <div>
          <h3 className="text-sm font-bold uppercase tracking-wider text-cream-50">Contact Us</h3>
          <ul className="mt-4 space-y-3 text-sm">
            <li className="flex items-start gap-2.5">
              ...
              <a href="tel:+2348027775001" className="hover:text-cream-50">
                0802 777 5001 <span className="text-white/50">(24/7 helpline)</span>
              </a>
            </li>
            <li className="flex items-start gap-2.5">
            ...
            <li className="flex items-start gap-2.5">
              ...
              <a href="mailto:goshenshelters2026@gmail.com" className="hover:text-cream-50">
        ...
        <div>
          <h3 className="text-sm font-bold uppercase tracking-wider text-cream-50">Get Help</h3>
          ...
          <div className="mt-8 rounded-2xl border border-night-800 bg-night-900 p-5">
            ...
            <p className="mt-1 text-xs leading-5 text-white/60">
              Every gift funds shelter, meals, healthcare, education and skills for women and children.
            </p>
            <Link
              href="/donate"
      ...
      <div className="border-t border-night-900">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-6 text-xs text-gold-400 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          <p>
            &copy; {new Date().getFullYear()} Goshen Shelters. All rights reserved.
          </p>
          <p>
            Registered NGO with the Corporate Affairs Commission, Nigeria &middot; CAC No. CAC/IT/No/77215
          </p>
