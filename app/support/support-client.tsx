  ...
  return (
    <main className="min-h-screen bg-[#F7F3EC]">
      <section className="relative isolate overflow-hidden text-cream-50">
        <Reveal>
          <div className="grid items-stretch lg:grid-cols-[40%_60%]">
            ...
            <div className="relative min-h-70 sm:min-h-140 lg:min-h-140 xl:min-h-160 2xl:min-h-200">
              <Image
                src="/images/00_Master_Approved_Source.jpg"
                alt="A helping hand"
                fill
                priority
        ...
        <Reveal delay={80}>
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3 relative mx-auto max-w-7xl px-4 sm:px-6 py-4  xl:-top-40">
