...
function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-night-950 text-cream-50">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-night-950/95 via-night-950/55 to-night-950/10" />
      ...
      <div className="relative mx-auto flex min-h-[90svh] max-w-7xl flex-col justify-center px-4 pb-20 pt-24 sm:px-6 lg:min-h-[82svh] lg:pb-24 lg:pt-28">
        <div className="max-w-2xl">
          ...
          >
            We provide hope, shelter, healing and practical support for women escaping domestic violence.
          </p>

          <div className="animate-fade-up mt-9 flex flex-col gap-3 sm:flex-row" style={{ animationDelay: "300ms" }}>
            <HelpButton
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gold-300">Confidential helpline · 24/7</p>
          ...
          <div className="animate-fade-up mt-8 flex max-w-xl flex-col gap-3 sm:flex-row" style={{ animationDelay: "500ms" }}>
            <div className="flex flex-1 items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur">
              ...
              <p className="text-sm leading-5 text-white/85">
                <span className="font-semibold text-white">100% confidential</span> — you are in control, always
              </p>
            </div>
            <div className="flex flex-1 items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur">
              <SparklesIcon className="h-5 w-5 shrink-0 text-gold-400" />
              <p className="text-sm leading-5 text-white/85">
                <span className="font-semibold text-white">Since 2015</span> — restoring women &amp; children in Nigeria
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto grid max-w-7xl gap-5 px-4 py-16 sm:px-6 lg:grid-cols-3">
        <Reveal>
          ...
          >
            ...
            <span className="mt-5 font-display text-xl font-semibold text-gold-700">I need help</span>
            <span className="mt-2 flex-1 text-sm leading-6 text-night-600">You are not alone. We are here for you.</span>
        ...
        <Reveal delay={80}>
          ...
          >
            ...
            <span className="mt-5 font-display text-xl font-semibold text-gold-700">I want to support</span>
            <span className="mt-2 flex-1 text-sm leading-6 text-night-600">Your support can change a life.</span>
            <span className="mt-5 inline-flex items-center gap-1.5 text-sm font-bold uppercase tracking-wider text-gold-700 group-hover:text-gold-600">
              Support Us
              <ArrowRightIcon className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </span>
        ...
        <Reveal delay={160}>
          ...
          >
            ...
            <span className="mt-5 font-display text-xl font-semibold text-gold-700">I want to partner</span>
            <span className="mt-2 flex-1 text-sm leading-6 text-night-600">Together, we can build a safer tomorrow.</span>
            <span className="mt-5 inline-flex items-center gap-1.5 text-sm font-bold uppercase tracking-wider text-gold-700 group-hover:text-gold-600">
              Work With Us
              <ArrowRightIcon className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </span>
  ...
  return (
    <section className="bg-cream-100">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:gap-16">
        <Reveal>
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-gold-600">Our Impact So Far</p>
          <h2 className="mt-3 font-display text-3xl font-semibold tracking-tight sm:text-4xl">
            Changing lives. Building hope.
          </h2>
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3">
            {IMPACT_STATS.map(({ value, label }, i) => (
              <Reveal key={label} delay={(i % 3) * 70} className="rounded-2xl border border-night-100 bg-white p-5 text-center shadow-sm transition-colors hover:border-gold-300">
        ...
        <Reveal delay={100}>
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-gold-600">A Message From Our Founder</p>
          <h2 className="mt-3 font-display text-3xl font-semibold tracking-tight sm:text-4xl">Why Goshen exists</h2>
          <div className="mt-8">
            <FounderVideo />
          </div>
